...
#%% The example code is an example for denosing the dynamic data, numbers in T1 refer to different timesteps.		
...
for T in T1:
    ...
    ###### Load trained Domain transfer module ######
    ...
    #%% Perform domain transfer at 2D X-Y plane
    ...
    netG_B_stacking =  ResnetGenerator(opt.output_nc, opt.input_nc,n_blocks=4)
    ...
    #%% Perform final segmentation using the trained Semantic_Indication_Modules
    net = uresnet()
